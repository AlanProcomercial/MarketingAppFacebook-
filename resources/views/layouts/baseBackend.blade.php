    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Phototec</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ url('/admin/contests') }}"><i class="fa fa-table fa-fw"></i>Contests</a>
                        </li>
                        <li>
                            <a href="{{ url('/admin/contestants') }}"><i class="fa fa-group fa-fw"></i> Contestants</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
